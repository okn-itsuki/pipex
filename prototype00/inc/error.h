...
/*   Updated: 2025/09/09 13:54:10 by iokuno           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define OPEN_ERROR "infile open \n"
# define PIPE_ERROR "pipe \n"
# define FORK_ERROR "fork \n"
# define MALLOC_ERROR "malloc \n"
# define DUP2_STDIN_ERROR "dup2 : prev_fd -> stdin\n"
# define DUP2_STDOUT_ERROR "dup2 : pipe write -> stdout\n"

// child_process.c
# define CMD_NOT_FOUND "command not found\n"
# define EXECVE_ERROR "execve \n"
